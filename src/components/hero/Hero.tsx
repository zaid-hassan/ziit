        ...
        >
          <div className="">
            <motion.h1
              ...
              animate={{ filter: "blur(0px)", opacity: 1 }}
              transition={{ duration: 1.4, ease: [0.33, 1, 0.68, 1] }}
              className="text-heading text-4xl md:text-6xl font-title text-left"
            >
            ...
            <motion.h1
              ...
              transition={{ duration: 1.4, ease: [0.33, 1, 0.68, 1] }}
              className="text-primary text-2xl md:text-4xl font-title text-left"
            >
              ...
              <Card className="bg-card">
                ...
                >
                  <GradientText
                    ...
                    animationSpeed={3}
                    showBorder={false}
                    className="font-display bg-transparent text-primary px-2 py-1 w-[80%] text-center shadow-md hover:shadow-lg transition-shadow duration-300 select-none"
                  >
